...
| **127** | Groupe opérant sur un ensemble. Exemples. | Théorème des deux carés | Irréductibilité des polynômes cyclotomiques|
| **141** | Groupe opérant sur un ensemble. Exemples. | Nombre d'irréductibles de $F_q[X]$ | Irréductibilité des polynômes cyclotomiques|
| **142** | Groupe opérant sur un ensemble. Exemples. | 26 est l'unique entier entre un cube et un carré | Théorème chinois et calcul de $\varphi(n)$|
| **144** | Groupe opérant sur un ensemble. Exemples. | Théorème de Kronecker et sous-groupes finis de $GL_n(\mathbb Z)$ | Irréductibilité des polynômes cyclotomiques|
| **148** | Groupe opérant sur un ensemble. Exemples. | Réduction de Frobenius | Réduction des endomorphismes normaux|
| **149** | Groupe opérant sur un ensemble. Exemples. | Déterminant de Gram et inégalité de Hadamard | Différentielle du déterminant et application au wronskien|
